...
$settings = array(
    0 =>
        array(
            ...
            'value'       => '[{"title":"Smart Fish - Manage and Monitor Your Aquarium with Smart Fish","favicon":"uploads\/favicon.png","address":"123 Smart Fish Lane Aquacity, Oceanland","phone":"+8801234567891","email":"example@smart-fish-bd.test","description":null}]',
            'field'       => json_encode([
                "name"      => "value",
                "label"     => "Setting",
                "type"      => "repeatable",
    ...
    5 =>
        array(
            ...
            'value'       => '<p>Welcome to Smart Fish, where innovation meets aquatic excellence. Our mission is to revolutionize the way people experience and interact with fishkeeping. As avid enthusiasts of marine life, we understand the importance of creating a harmonious environment for both fish and their owners.</p>',
            'field'       => json_encode([
                'name'      => 'value',
