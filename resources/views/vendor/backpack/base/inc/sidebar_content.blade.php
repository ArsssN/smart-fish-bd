...
<li class='nav-item'><a class='nav-link' href='{{ backpack_url('reports/sensors') }}'><i class='nav-icon la la-chart-line'></i> Sensors Reports</a></li>
<li class='nav-item'><a class='nav-link' href='{{ backpack_url('reports/aerators') }}'><i class='nav-icon la la-chart-line'></i> Aerators Reports</a></li>
