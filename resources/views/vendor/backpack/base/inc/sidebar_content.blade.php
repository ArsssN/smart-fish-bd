...
<li class="nav-item nav-dropdown">
    <a class="nav-link nav-dropdown-toggle" href="#" title="Project Management"><i class="nav-icon la la-users"></i> <span>Project Manage.</span></a>
    <ul class="nav-dropdown-items">
        <li class='nav-item'><a class='nav-link' href='{{ backpack_url('project') }}'><i class='nav-icon la la-question'></i> Projects</a></li>
        <li class='nav-item'><a class='nav-link' href='{{ backpack_url('sensor-group') }}'><i class='nav-icon la la-question'></i> Sensor groups</a></li>
        <li class='nav-item'><a class='nav-link' href='{{ backpack_url('sensor') }}'><i class='nav-icon la la-question'></i> Sensors</a></li>
    </ul>
</li>
