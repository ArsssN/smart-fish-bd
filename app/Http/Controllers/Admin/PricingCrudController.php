...
class PricingCrudController extends CrudController
{
    ...
    protected function setupListOperation()
    {
        ...
        CRUD::column('card_bg_color')->type('select_from_array')->options(Pricing::CARD_BG_COLOR);
    ...
    protected function setupCreateOperation()
    {
        ...
        CRUD::field('card_bg_color')->type('select_from_array')->options(Pricing::CARD_BG_COLOR);
