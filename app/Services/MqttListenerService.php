...
class MqttListenerService
{
    ...
    {
        Log::channel('mqtt_listener')->notice('isUpdate : ' . self::$isUpdate . ' -- ' . '; isPublishable: ' . self::$isPublishable . ' -- ' . '; Publishable: ' . $publishable);
    ...
    {
        Log::channel('mqtt_listener')->notice('isSaveMqttData : ' . self::$isSaveMqttData . ' -- ' . '; isNotAlreadyPublished: ' . !self::$isAlreadyPublished . ' -- ' . '; Savable: ' . $savable);
