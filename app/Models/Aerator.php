...
/**
 * @mixin IdeHelperAerator
 */
class Aerator extends Model
{
    ...
    */
    ...
    /**
     * The projects that belong to the Aerator
     *
     * @return BelongsToMany
     */
    public function projects(): BelongsToMany
    {
        return $this->belongsToMany(Project::class, 'aerator_project');
    }
