        ...
        try {
            $mqtt->subscribe('SFBD/+/PUB', function (string $topic, string $message) {
                ...
                try {
                    ...
                    Log::channel('mqtt_listener')->info("Switch: {$mqttListenerService::$switchUnit->name}, Run Status: {$mqttListenerService::$switchUnit->run_status}, Run At: {$mqttListenerService::$switchUnit->run_status_updated_at}");
                    ...
                    if ($mqttListenerService::checkIfPublishable()) {
                        MqttPublishService::relayPublish(!!$mqttListenerService::$switchUnit->run_status_updated_at);
                    }
                    ...
                    if ($mqttListenerService::checkIfSavable()) {
                        MqttStoreService::init($this->topic, $mqttListenerService::$mqttDataInstance, $mqttListenerService::$switchUnit, $mqttListenerService::$historyDetails, 'mqtt')
                            ->mqttDataSave()
